...
# Sane OSX defaults
# ~/.osx — http://mths.be/osx (this is the original version)
...
# Disable “natural” (Lion-style) scrolling (does not work on mojave?)
...
# Finder: disable quicklook animations
